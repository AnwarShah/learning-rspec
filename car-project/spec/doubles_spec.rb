describe 'Doubles' do
  ...
  context 'with partial test doubles' do
    ...
    it 'allows stubbing instace methods of Ruby classes' do
    ...
    it 'allows stubbing class methods on Ruby clasess' do
  ...
  context 'with argument constraints' do
    ...
    it "allows containing only some arguments" do
      dbl = double("Customer List")
